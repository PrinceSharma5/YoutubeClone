...
function VideoPlayer () {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        axios
            .get(`https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
            .then(response => {
    ...
    async function createVideoInfo(video) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
    ...
    if (isError) {
        return <FiAlertCircle severity="error" className='loading'>No Results found!</FiAlertCircle>
    }
    return (
