...
function SearchPage(props) {
    ...
    useEffect(() => {
        ...
        setVideoRows([]);
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=channel&q=${searchQuery}&safeSearch=none&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
            .then(response => {
        ...
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=9&type=video&q=${searchQuery}&safeSearch=none&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
            .then(response => {
    ...
    async function createChannelRow(channel) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=statistics&id=${channelId}&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
    ...
    async function createVideoRows(videos) {
        ...
        for (const video of videos) {
            ...
            const response = await axios
                .get(`https://www.googleapis.com/youtube/v3/videos?part=statistics%2C%20snippet&id=${videoId}&key=AIzaSyDKZ38zZOEU3LQZ9dCkgAF23-oFgF91-t8`)
